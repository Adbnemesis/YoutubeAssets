...
export const defaultMechaTrioProps: MonsterTrioEditProps = {
  fps: 60,
  durationInFrames: 525,
  width: 1080,
  height: 1080,
  ...
  brawlers: [
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/surge", frameCount: 97, gifFps: 24 },
      backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
      backgroundBoost: 1.3,
      entrance: "rise",
      voiceLine: staticFile("brawler_voices/surge/surge_atk_vo_04.ogg"),
      accentColor: "#f97316",
      introImageStartFrame: 0,
      textCardStartFrame: 44,
      secondaryPoseStartFrame: 76,
    ...
    },
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/meg", frameCount: 149, gifFps: 24 },
      backgroundImage: staticFile("brawl_backgrounds/background_windstock_1.png"),
      backgroundBoost: 1.35,
      entrance: "slideLeft",
      voiceLine: staticFile("brawler_voices/meg/meg_start_vo_02.ogg"),
      accentColor: "#ec4899",
      introImageStartFrame: 139,
      textCardStartFrame: 171,
      secondaryPoseStartFrame: 204,
    ...
    },
    {
      ...
      backgroundBoost: 1.25,
      entrance: "slideRight",
      voiceLine: staticFile("brawler_voices/frank/attack.ogg"),
      accentColor: "#a855f7",
      introImageStartFrame: 267,
      textCardStartFrame: 299,
      secondaryPoseStartFrame: 332,
  ...
  climax: {
    ...
    rapidPanels: [
      ...
      {
        image: staticFile("images/surge/surge_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
        backgroundBoost: 1.3,
        accentColor: "#f97316",
      },
      {
        image: staticFile("images/meg/meg_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_windstock_1.png"),
        backgroundBoost: 1.35,
        accentColor: "#ec4899",
      },
      ...
      {
        image: staticFile("images/surge/surge_panel_15.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
        backgroundBoost: 1.2,
        accentColor: "#f97316",
      },
    ],
    victoryStance: staticFile("images/surge/surge_panel_15.png"),
    voiceLines: [
      staticFile("brawler_voices/surge/surge_atk_vo_04.ogg"),
      staticFile("brawler_voices/meg/meg_start_vo_02.ogg"),
    ],
    startFrame: 395,
    endFrame: 525,
  },
...
export const rangerRanchMonsterTrioProps: MonsterTrioEditProps = {
  fps: 60,
  durationInFrames: 525,
  width: 1080,
  height: 1080,
  ...
  brawlers: [
    {
      ...
      name: "Colt",
      text: "COLT",
      image: staticFile("images/colt/colt_panel_1.png"),
      secondaryPoseGif: { base: "brawler_gif_frames/colt", frameCount: 116 },
      backgroundImage: staticFile("brawl_backgrounds/background_windstock_1.png"),
      backgroundBoost: 1.25,
      entrance: "rise",
      voiceLine: staticFile("brawler_voices/colt/colt_kill_04.ogg"),
      accentColor: "#3b82f6",
      introImageStartFrame: 0,
      textCardStartFrame: 44,
      secondaryPoseStartFrame: 76,
    ...
    },
    {
      ...
      name: "Shelly",
      text: "SHELLY",
      image: staticFile("images/shelly/shelly_panel_1.png"),
      secondaryPoseGif: { base: "brawler_gif_frames/shelly", frameCount: 49 },
      backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
      backgroundBoost: 1.35,
      entrance: "slideLeft",
      voiceLine: staticFile("brawler_voices/shelly/super.ogg"),
      accentColor: "#a855f7",
      introImageStartFrame: 139,
      textCardStartFrame: 171,
      secondaryPoseStartFrame: 204,
    ...
    },
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/spike", frameCount: 33 },
      backgroundImage: staticFile("brawl_backgrounds/background_angel1.png"),
      backgroundBoost: 1.3,
      entrance: "slideRight",
      voiceLine: staticFile("sound_effects/spike_super_explosion.mp3"),
      accentColor: "#22c55e",
      introImageStartFrame: 267,
      textCardStartFrame: 299,
      secondaryPoseStartFrame: 332,
  ...
  climax: {
    ...
    rapidPanels: [
      ...
      {
        image: staticFile("images/colt/colt_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_windstock_1.png"),
        backgroundBoost: 1.25,
        accentColor: "#3b82f6",
      },
      {
        image: staticFile("images/shelly/shelly_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
        backgroundBoost: 1.35,
        accentColor: "#a855f7",
      },
      {
        image: staticFile("images/spike/spike_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_angel1.png"),
        backgroundBoost: 1.3,
        accentColor: "#22c55e",
      },
      {
        image: staticFile("images/shelly/shelly_panel_15.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
        backgroundBoost: 1.2,
        accentColor: "#a855f7",
      },
    ],
    victoryStance: staticFile("images/shelly/shelly_panel_15.png"),
    voiceLines: [
      staticFile("brawler_voices/colt/colt_kill_04.ogg"),
      staticFile("brawler_voices/shelly/super.ogg"),
    ],
    startFrame: 395,
    endFrame: 525,
  },
...
export const shamanTribeMonsterTrioProps: MonsterTrioEditProps = {
  fps: 60,
  durationInFrames: 525,
  width: 1080,
  height: 1080,
  ...
  brawlers: [
    ...
    },
    {
      ...
      name: "Nita",
      text: "NITA",
      image: staticFile("images/nita/nita_panel_1.png"),
      secondaryPoseGif: { base: "brawler_gif_frames/nita", frameCount: 69 },
      backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
      backgroundBoost: 1.35,
      entrance: "slideLeft",
      voiceLine: staticFile("brawler_voices/nita/nita_ulti_vo_01.ogg"),
      accentColor: "#ef4444",
      introImageStartFrame: 139,
      textCardStartFrame: 171,
      secondaryPoseStartFrame: 204,
    ...
    },
    {
      ...
      name: "Bo",
      text: "BO",
      image: staticFile("images/bo/bo_panel_1.png"),
      secondaryPoseGif: { base: "brawler_gif_frames/bo", frameCount: 79 },
      backgroundImage: staticFile("brawl_backgrounds/background_angel1.png"),
      backgroundBoost: 1.3,
      entrance: "slideRight",
      voiceLine: staticFile("brawler_voices/bo/bo_ulti_vo_01.ogg"),
      accentColor: "#eab308",
      introImageStartFrame: 267,
      textCardStartFrame: 299,
      secondaryPoseStartFrame: 332,
  ...
  climax: {
    ...
    rapidPanels: [
      ...
      {
        image: staticFile("images/nita/nita_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
        backgroundBoost: 1.35,
        accentColor: "#ef4444",
      },
      {
        image: staticFile("images/bo/bo_panel_4.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_angel1.png"),
        backgroundBoost: 1.3,
        accentColor: "#eab308",
      },
      {
        image: staticFile("images/bo/bo_panel_15.png"),
        backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
        backgroundBoost: 1.2,
        accentColor: "#eab308",
      },
    ],
    victoryStance: staticFile("images/bo/bo_panel_15.png"),
    voiceLines: [
      staticFile("brawler_voices/leon/leon_ulti_vo_01.ogg"),
      staticFile("brawler_voices/bo/bo_ulti_vo_01.ogg"),
    ],
    startFrame: 395,
    endFrame: 525,
  },
