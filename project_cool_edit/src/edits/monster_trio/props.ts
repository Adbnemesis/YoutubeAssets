  ...
  brawlers: [
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/colt", frameCount: 1 },
      backgroundImage: staticFile("brawl_backgrounds/background_windstock_1.png"),
      backgroundBoost: 1.25,
      entrance: "rise",
    ...
    },
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/shelly", frameCount: 1 },
      backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
      backgroundBoost: 1.35,
      entrance: "slideLeft",
    ...
    },
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/spike", frameCount: 1 },
      backgroundImage: staticFile("brawl_backgrounds/background_angel1.png"),
      backgroundBoost: 1.3,
      entrance: "slideRight",
...
export const shamanTribeMonsterTrioProps: MonsterTrioEditProps = {
  ...
  brawlers: [
    ...
    },
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/nita", frameCount: 1 },
      backgroundImage: staticFile("brawl_backgrounds/background_anime.png"),
      backgroundBoost: 1.35,
      entrance: "slideLeft",
    ...
    },
    {
      ...
      secondaryPoseGif: { base: "brawler_gif_frames/bo", frameCount: 1 },
      backgroundImage: staticFile("brawl_backgrounds/background_angel1.png"),
      backgroundBoost: 1.3,
      entrance: "slideRight",
