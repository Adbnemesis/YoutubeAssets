...
| `Scene 4` | `F076 → F139` | `1.267s → 2.300s` | `63f` | Brawler 1 (Mortis): Action Stance 2 | Secondary action pose cut, purple particle aura (`#a855f7`), Chromatic Aberration RGB split | **Cut #2 / Beat Hit (F76)** | None | `mortis_panel_4.png` | `brawlers[0]` (mode: `action_pose`) |
...
| `Scene 9` | `F204 → F267` | `3.400s → 4.450s` | `63f` | Brawler 2 (Edgar): Action Stance 2 | Secondary action pose cut, red particle aura (`#ef4444`), Chromatic Aberration RGB split | **Cut #4 / Beat Hit (F204)** | None | `edgar_panel_4.png` | `brawlers[1]` (mode: `action_pose`) |
...
| `Scene 14 & 15` | `F332 → F395` | `5.533s → 6.583s` | `63f` | Brawler 3 (Crow): Action Stance 2 | Secondary action pose cut, electric blue particle aura (`#3b82f6`) | **Cut #6 / Beat Hit (F332)** | None | `crow_panel_4.png` | `brawlers[2]` (mode: `action_pose`) |
| `Scene 16 → 19` | `F395 → F525` | `6.583s → 8.824s` | `130f` | **7-Panel Rapid Alternating Slide Climax** | **6.58s to 8.82s**: 7 distinct panels alternating Left-to-Right & Right-to-Left slide transitions, gold title text `"MONSTER TRIO 👑"`, victory stance | **Climax Beat Onset (F395)** | `"MONSTER TRIO 👑"` (Gold `#fbbf24`) | 7 Rapid Panels & Victory Stance | `climax` |
