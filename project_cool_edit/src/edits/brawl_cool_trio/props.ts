...
// Tara / Leon / Crow — same brawl_cool_trio analysis & timing, new trio.
// Substitution map (keeps identical structure/timestamps): edgar→tara (#a855f7),
// mortis→leon (#22c55e), kenji→crow (#3b82f6). Same BGM track.
export const taraLeonCrowProps = {
  // Dedicated mixed audio: the reference edit's music (trio_edit.wav, anime vocals
  // stripped via demucs) + Tara/Leon/Crow VO baked in at the exact blueprint
  // timestamps (7.40s / 9.30s / 11.74s) — same pattern as sample_audio.wav.
  ...
  cards: [
    ...
    // ============ TARA SECTION (~7.5s VO — baked into audio/tara_leon_crow_audio.wav) ============
    // 1) Silhouette Phase
    {
      startTime: 7.40,
      endTime: 7.90,
    ...
    // ============ LEON SECTION (~9.5s VO — baked into audio/tara_leon_crow_audio.wav) ============
    // 1) Silhouette Phase
    {
      startTime: 9.30,
      endTime: 9.80,
      layout: "single",
      backgroundImage: "images/tara/tara_panel_4.png", // Matches Tara's background at this time
      effects: ["glitch"],
      images: [
    ...
    // ============ CROW SECTION (~11.5s VO — baked into audio/tara_leon_crow_audio.wav) ============
    // 1) Silhouette Phase
    {
      startTime: 11.74,
      endTime: 12.24,
      layout: "single",
      backgroundImage: "images/leon/leon_panel_3.png", // Matches Leon's background at this time
      effects: ["glitch"],
      images: [
