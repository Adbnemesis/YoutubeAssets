...
import { phonkPrototypeProps, mangaPhonkProps, midnightTrioProps, superheroTrioProps, bibiEdgarFrankProps, kenjiKazeNoriProps, tankTitansProps } from "./props";
...
export const PhonkCompositions: React.FC = () => {
  return (
    <>
      ...
      <Composition
        id="BrawlForms-TankTitans"
        component={MidnightTrioTemplate}
        durationInFrames={585}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={tankTitansProps}
      />
    </>
  );
};
