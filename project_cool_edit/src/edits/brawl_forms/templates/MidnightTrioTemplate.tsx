...
export const MidnightTrioTemplate: React.FC<PhonkMasterProps> = ({
  audioSrc,
  introForms,
  dropClips,
  dropCuts,
      ...
      {frame < 75 && (
        <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", zIndex: 100 }}>
          <div style={{
            ...
            lineHeight: 1.1,
            textShadow: "0 10px 20px rgba(0,0,0,0.8), 0 0 30px #a855f7, 0 0 60px #22c55e",
            ...
            MIDNIGHT<br />
            <span style={{ color: "#a855f7", textShadow: "0 10px 20px rgba(0,0,0,0.8), 0 0 30px #22c55e" }}>TRIO</span>
          </div>
        </AbsoluteFill>
      )}
