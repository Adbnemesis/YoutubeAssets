...
export const GlitchEffect: React.FC<GlitchEffectProps> = ({ form1Panels, form4Panels, form1IconSrc, form4IconSrc }) => {
  ...
  return (
    ...
    >
      {swapVal ? (
        <MangaGridReveal auraColor="#facc15" iconSrc={form1IconSrc} panels={form1Panels} forceComplete />
      ) : (
        <MangaGridReveal auraColor="#3b82f6" iconSrc={form4IconSrc} panels={form4Panels} forceComplete />
      )}
