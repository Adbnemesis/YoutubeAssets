...
const BRAWLER_GIF_MAP: Record<string, BrawlerGifMetadata> = {
  ...
  "brawler_gifs/colt_win.gif": { base: "brawler_gif_frames/colt", frameCount: 116, gifFps: 24 },
  "brawler_gifs/shelly_win.gif": { base: "brawler_gif_frames/shelly", frameCount: 49, gifFps: 24 },
  "brawler_gifs/spike_win.gif": { base: "brawler_gif_frames/spike", frameCount: 33, gifFps: 24 },
  "brawler_gifs/nita_win.gif": { base: "brawler_gif_frames/nita", frameCount: 69, gifFps: 24 },
  "brawler_gifs/bo_win.gif": { base: "brawler_gif_frames/bo", frameCount: 79, gifFps: 24 },
};
