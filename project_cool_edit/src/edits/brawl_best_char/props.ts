...
export const bestControllerProps: BestCharEditProps = {
  fps: 30,
  durationInFrames: 377,
  width: 720,
  height: 1280,
  ...
  theme: {
    fontFamily: "'Outfit', 'Impact', sans-serif",
    bgGradient: "radial-gradient(circle at center, #1e1b4b 0%, #0f172a 45%, #020617 100%)",
    textShadow: "0 0 35px #38bdf8, 0 0 70px #0284c7, 0 0 100px #000000",
    textStroke: "4px #000000",
    sunburstColors: "conic-gradient(from 0deg, rgba(56, 189, 248, 0.35) 0deg 15deg, transparent 15deg 30deg, rgba(168, 85, 247, 0.35) 30deg 45deg, transparent 45deg 60deg)",
    centerGlowColor: "radial-gradient(circle, rgba(56, 189, 248, 0.6) 0%, rgba(168, 85, 247, 0.35) 45%, transparent 75%)",
  },
  intro: {
    headerText: "THE BEST CONTROLLER",
    subText: "WHO HAS BEST CONTROL?",
    startFrame: 0,
    endFrame: 64,
    bgImages: [
      staticFile("images/willow/willow_panel_1.png"),
      staticFile("images/gale/gale_panel_1.png"),
      staticFile("images/sandy/sandy_panel_1.png"),
      staticFile("images/kenji/kenji_panel_1.png"),
    ]
  },
  contenders: [
    {
      ...
      name: "Willow",
      questionText: "WILLOW?",
      image: staticFile("images/willow/willow_panel_1.png"),
      accentColor: "#10b981",
      startFrame: 64,
      endFrame: 96,
    },
    {
      ...
      name: "Gale",
      questionText: "GALE?",
      image: staticFile("images/gale/gale_panel_1.png"),
      accentColor: "#38bdf8",
      startFrame: 96,
      endFrame: 127,
    },
    ...
    },
    {
      ...
      questionText: "SANDY?",
      image: staticFile("images/sandy/sandy_panel_1.png"),
      secondaryImage: staticFile("images/sandy/sandy_panel_4.png"),
      voiceLine: staticFile("brawler_voices/sandy/sandy_ulti_vo_01.ogg"),
      accentColor: "#fbbf24",
      startFrame: 222,
      endFrame: 313,
    },
...
export const bestAssassinProps: BestCharEditProps = {
  fps: 30,
  durationInFrames: 377,
  width: 720,
  height: 1280,
  ...
  theme: {
    fontFamily: "'Outfit', 'Impact', sans-serif",
    bgGradient: "radial-gradient(circle at center, #831843 0%, #4c0519 45%, #050508 100%)",
    textShadow: "0 0 35px #f43f5e, 0 0 70px #e11d48, 0 0 100px #000000",
    textStroke: "4px #000000",
    sunburstColors: "conic-gradient(from 0deg, rgba(244, 63, 94, 0.35) 0deg 15deg, transparent 15deg 30deg, rgba(236, 72, 153, 0.35) 30deg 45deg, transparent 45deg 60deg)",
    centerGlowColor: "radial-gradient(circle, rgba(244, 63, 94, 0.6) 0%, rgba(236, 72, 153, 0.35) 45%, transparent 75%)",
  },
  intro: {
    headerText: "THE BEST ASSASSIN",
    subText: "WHO HAS THE DEADLIEST STRIKE?",
    startFrame: 0,
    endFrame: 64,
    bgImages: [
      staticFile("images/edgar/edgar_panel_1.png"),
      staticFile("images/mortis/mortis_panel_1.png"),
      staticFile("images/leon/leon_panel_1.png"),
      staticFile("images/bibi/bibi_panel_1.png"),
    ]
  },
  contenders: [
    ...
    },
    {
      ...
      questionText: "KAZE?",
      image: staticFile("images/kaze/kaze_panel_1.png"),
      secondaryImage: staticFile("images/kaze/kaze_panel_4.png"),
  ...
  winner: {
    id: "bibi",
    name: "Bibi",
    announcementText: "OFC IT'S BIBI 👑",
    image: staticFile("images/bibi/bibi_panel_1.png"),
    winnerPanels: [
      staticFile("images/bibi/bibi_panel_1.png"),
      staticFile("images/bibi/bibi_panel_3.png"),
      staticFile("images/bibi/bibi_panel_5.png"),
      staticFile("images/bibi/bibi_panel_7.png"),
      staticFile("images/bibi/bibi_panel_9.png"),
      staticFile("images/bibi/bibi_panel_12.png"),
      staticFile("images/bibi/bibi_panel_15.png"),
    ],
    voiceLines: [
      staticFile("brawler_voices/bibi/attack.ogg"),
      staticFile("brawler_voices/bibi/super.ogg"),
    ],
    accentColor: "#f43f5e",
    startFrame: 313,
    endFrame: 377,
