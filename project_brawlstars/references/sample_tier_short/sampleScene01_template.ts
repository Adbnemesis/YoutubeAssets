...
export const sampleSceneConfig: RankingVideoConfig = {
  ...
  titleWords: [
    { text: "WHO", frame: 0, fontSize: 96, color: "#22C55E" },
    { text: "IS", frame: 14, fontSize: 96, color: "#22C55E" },
    { text: "THE", frame: 20, fontSize: 96, color: "#22C55E" },
    { text: "BEST", frame: 24, fontSize: 96, color: "#22C55E" },
    { text: "BRAWLER", frame: 32, fontSize: 82, color: "#22C55E" },
    { text: "IN", frame: 47, fontSize: 96, color: "#22C55E" },
    { text: "BRAWL", frame: 53, fontSize: 88, color: "#22C55E" },
    { text: "STARS?", frame: 64, fontSize: 84, color: "#22C55E" },
  ],
  ...
  // Fight dialogue — "I smell zombie!" (reference 8.16-9.78s)
  fightDialogue: {
    text: "I smell zombie!",
    from: 245, // 8.17s
    to: 293, // 9.77s
