...
class Compressor:
    ...
    def compress(
        self, data: bytes, signature: Signatures, file_version: int = None, metadata: bytes | None = None
    ) -> bytes:
        ...
        compressed = self._write_header(compressed, data, file_version, signature, metadata)

        return compressed

    @staticmethod
    def _write_header(
        compressed: bytes, data: bytes, file_version: int, signature: Signatures, metadata: bytes | None
    ) -> bytes:
