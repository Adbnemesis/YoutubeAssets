...
10. **Law of Natural Crisp Endings (Zero Forced Loops):** Only use an infinite loop transition if it flows 100% naturally and unforced. Never insert awkward trailing clauses (e.g. "Because...", "Before everyone finds out that...") just for the sake of an infinite loop. If a natural loop doesn't fit effortlessly, end crisply on a high-energy mascot punchline or definitive mic-drop payoff.
