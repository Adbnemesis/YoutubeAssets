...
// ULTRA-HIGH VISIBILITY (+20% TOTAL BOOST) (~19.72s @ 30fps)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// BEAT 1: BROWSER ADDRESS BAR & ENTER IGNITION (Ultra Boosted)
// ═══════════════════════════════════════════════════════════════
const Beat1AddressBar: React.FC<{
  ...
  const packetY = interpolate(frame, [fPacketLaunch, fPacketLaunch + 25], [540, 1100], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 32,
        border: `3.5px solid ${isEntered ? "#38BDF8" : nemiTheme.colors.borderSubtle}`,
        boxShadow: isEntered ? "0 28px 70px rgba(56, 189, 248, 0.32)" : "0 28px 70px rgba(0, 0, 0, 0.1)",
        padding: "36px",
        display: "flex",
        flexDirection: "column",
        justifyContent: "space-between",
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div style={{ width: 18, height: 18, borderRadius: "50%", backgroundColor: "#10B981" }} />
        <div style={{ marginLeft: 16, backgroundColor: "#F1F5F9", padding: "12px 24px", borderRadius: 14, fontSize: 20, color: "#64748B", fontWeight: 800 }}>
          New Tab — Chrome V128
        </div>
      </div>
      ...
      <div
        style={{
          ...
          borderRadius: 24,
          border: `3.5px solid ${isEntered ? "#0284C7" : "#E2E8F0"}`,
          padding: "24px 30px",
          display: "flex",
          alignItems: "center",
          justifyContent: "space-between",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <span style={{ fontSize: 40, fontWeight: 900, color: "#0F172A", fontFamily: nemiTheme.typography.fontFamily.mono }}>
            {currentText}
        ...
        <div
          style={{
            ...
            boxShadow: isEntered ? "0 0 28px rgba(2, 132, 199, 0.5)" : "none",
          }}
        >
          ENTER ↵
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        <div style={{ backgroundColor: "#F1F5F9", padding: "22px", borderRadius: 22 }}>
          <div style={{ fontSize: 18, color: "#64748B", fontWeight: 700 }}>Protocol</div>
          <div style={{ fontSize: 28, fontWeight: 900, color: "#0284C7", fontFamily: nemiTheme.typography.fontFamily.mono, marginTop: 4 }}>
            HTTP/3 (QUIC / UDP)
          </div>
        </div>
        <div style={{ backgroundColor: "#F1F5F9", padding: "22px", borderRadius: 22 }}>
          <div style={{ fontSize: 18, color: "#64748B", fontWeight: 700 }}>Client Socket</div>
...
// ═══════════════════════════════════════════════════════════════
// BEAT 2: RECURSIVE DNS RESOLUTION MATRIX (Ultra Boosted)
// ═══════════════════════════════════════════════════════════════
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 32,
        border: "3.5px solid rgba(56, 189, 248, 0.6)",
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <span style={{ fontSize: 20, color: isResolved ? "#10B981" : "#F59E0B", fontWeight: 900, fontFamily: nemiTheme.typography.fontFamily.mono }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div style={{ backgroundColor: "#0F172A", padding: "18px 24px", borderRadius: 20, border: "1px solid #1E293B", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: 17, color: "#64748B", fontWeight: 700 }}>01. Root DNS Server (.)</div>
          ...
          <span style={{ color: "#10B981", fontSize: 26 }}>✓</span>
        </div>

        <div style={{ backgroundColor: "#0F172A", padding: "18px 24px", borderRadius: 20, border: "1px solid #1E293B", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: 17, color: "#64748B", fontWeight: 700 }}>02. TLD Name Server (.com)</div>
            <div style={{ fontSize: 23, color: "#94A3B8", fontFamily: nemiTheme.typography.fontFamily.mono, marginTop: 2 }}>
        ...
        <div
          style={{
            backgroundColor: isResolved ? "rgba(16, 185, 129, 0.22)" : "#0F172A",
            padding: "22px 28px",
            borderRadius: 22,
            border: isResolved ? "3.5px solid #10B981" : "1px solid #1E293B",
            boxShadow: isResolved ? "0 0 45px rgba(16, 185, 129, 0.4)" : "none",
            display: "flex",
            justifyContent: "space-between",
            alignItems: "center",
        ...
        >
          <div>
            <div style={{ fontSize: 18, color: isResolved ? "#10B981" : "#64748B", fontWeight: 800 }}>
              03. Authoritative DNS (google.com)
            </div>
            <div style={{ fontSize: 38, fontWeight: 900, color: isResolved ? "#F8FAFC" : "#64748B", fontFamily: nemiTheme.typography.fontFamily.mono, marginTop: 4 }}>
...
// ═══════════════════════════════════════════════════════════════
// BEAT 3: UNDERSEA FIBER & BGP ROUTING GRID (Ultra Boosted)
// ═══════════════════════════════════════════════════════════════
    ...
    >
      ...
      <div style={{ width: "100%", height: 380, position: "relative" }}>
        <svg width="100%" height="100%" viewBox="0 0 900 380" style={{ overflow: "visible" }}>
          <path
            d="M 120,60 C 300,60 300,190 500,190 C 700,190 700,320 820,320"
            fill="none"
          ...
          <circle cx="120" cy="60" r="22" fill="#0F172A" stroke="#06B6D4" strokeWidth="7" />
          <circle cx="500" cy="190" r="22" fill="#0F172A" stroke="#FFD166" strokeWidth="7" />
          <circle cx="820" cy="320" r="28" fill="#10B981" stroke="#FFFFFF" strokeWidth="7" />
        </svg>

        {/* Node Labels */}
        <div style={{ position: "absolute", top: 40, left: 165, color: "#F8FAFC", fontSize: 22, fontWeight: 800 }}>
          01. Local ISP Gateway
        </div>
        <div style={{ position: "absolute", top: 170, left: 545, color: "#FFD166", fontSize: 22, fontWeight: 800 }}>
          02. Tier-1 Backbone (AS15169)
        </div>
        <div style={{ position: "absolute", top: 300, left: 600, color: "#10B981", fontSize: 26, fontWeight: 900 }}>
          03. Google Edge CDN ✓
        </div>
      </div>

      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 19, fontFamily: nemiTheme.typography.fontFamily.mono, color: "#94A3B8" }}>
...
// ═══════════════════════════════════════════════════════════════
// BEAT 4: GOOGLE EDGE SERVER & TLS 1.3 HANDSHAKE (Ultra Boosted)
// ═══════════════════════════════════════════════════════════════
  ...
  return (
    <div
      style={{
        ...
        boxShadow: "0 28px 70px rgba(16, 185, 129, 0.32)",
        padding: "32px 36px",
        display: "flex",
        flexDirection: "column",
        justifyContent: "space-between",
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <span style={{ fontSize: 28, fontWeight: 900, color: "#10B981", letterSpacing: "1.5px", textTransform: "uppercase" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        <div style={{ backgroundColor: "#0F172A", padding: "24px", borderRadius: 22, border: "1px solid #1E293B" }}>
          <div style={{ fontSize: 18, color: "#64748B", fontWeight: 700 }}>Cryptographic Handshake</div>
        ...
        <div style={{ backgroundColor: "#0F172A", padding: "24px", borderRadius: 22, border: "1px solid #1E293B" }}>
          <div style={{ fontSize: 18, color: "#64748B", fontWeight: 700 }}>Generated Payload</div>
          <div style={{ fontSize: 28, fontWeight: 900, color: "#FFD166", fontFamily: nemiTheme.typography.fontFamily.mono, marginTop: 4 }}>
      ...
      >
        <div>
          <div style={{ fontSize: 18, color: "#64748B", fontWeight: 700 }}>HTTP/2 Stream #1</div>
          <div style={{ fontSize: 28, fontWeight: 900, color: "#F8FAFC", fontFamily: nemiTheme.typography.fontFamily.mono }}>
        ...
        <div
          style={{
            ...
            fontSize: 22,
            fontFamily: nemiTheme.typography.fontFamily.mono,
            boxShadow: isShootingBack ? "0 0 32px #10B981" : "none",
          }}
        >
...
// ═══════════════════════════════════════════════════════════════
// BEAT 5: CRITICAL RENDERING PATH & DOM PAINT (Ultra Boosted)
// ═══════════════════════════════════════════════════════════════
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <span style={{ fontSize: 28, fontWeight: 900, color: "#0F172A", letterSpacing: "1px" }}>
      ...
      >
        ...
        <div style={{ fontSize: 78, fontWeight: 900, letterSpacing: "-2px" }}>
        ...
        >
          <span style={{ fontSize: 25, color: "#94A3B8" }}>Search Google or type a URL</span>
          <span style={{ fontSize: 32 }}>🔍</span>
        </div>
      </div>

      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 20, fontFamily: nemiTheme.typography.fontFamily.mono, color: "#64748B" }}>
...
// ═══════════════════════════════════════════════════════════════
// BEAT 6: 3-POINT CS TAKEAWAY & 64ms LATENCY PAYOFF (Ultra Boosted)
// ═══════════════════════════════════════════════════════════════
  ...
  return (
    ...
    >
      ...
      <div style={{ backgroundColor: "#27272A", padding: "20px 26px", borderRadius: 20, borderLeft: "7px solid #38BDF8" }}>
        <div style={{ fontSize: 28, fontWeight: 900, color: "#F8FAFC" }}>01. Recursive DNS Hierarchy</div>
        <div style={{ fontSize: 22, color: "#94A3B8", marginTop: 4 }}>
          Domain resolved to server IP in a single sub-millisecond cached query.
        </div>
      </div>

      <div style={{ backgroundColor: "#27272A", padding: "20px 26px", borderRadius: 20, borderLeft: "7px solid #06B6D4" }}>
        <div style={{ fontSize: 28, fontWeight: 900, color: "#F8FAFC" }}>02. Undersea Fiber Optic BGP</div>
        <div style={{ fontSize: 22, color: "#94A3B8", marginTop: 4 }}>
      ...
      <div style={{ backgroundColor: "#27272A", padding: "20px 26px", borderRadius: 20, borderLeft: "7px solid #10B981" }}>
        <div style={{ fontSize: 28, fontWeight: 900, color: "#F8FAFC" }}>03. GPU-Accelerated DOM Paint</div>
        <div style={{ fontSize: 22, color: "#94A3B8", marginTop: 4 }}>
  ...
  return (
    ...
    >
        ...
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", padding: "18px 28px", borderRadius: 28, boxShadow: "0 10px 30px rgba(0,0,0,0.09)", display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <span style={{ fontSize: 26, fontWeight: 900, color: "#1E293B" }}>Client Device</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", padding: "18px 28px", borderRadius: 28, boxShadow: "0 10px 30px rgba(0,0,0,0.09)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>📡</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#0284C7" }}>5GHz Wi-Fi</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", padding: "18px 28px", borderRadius: 28, boxShadow: "0 10px 30px rgba(0,0,0,0.09)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>⚡</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#10B981" }}>QUIC / UDP</span>
            </div>
          </div>
      ...
      {isStage2 && (
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(255, 209, 102, 0.45)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>📖</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#FFD166" }}>DNS Phonebook</span>
            </div>

            <span style={{ fontSize: 36, color: "#FFD166", fontWeight: 900 }}>➔</span>

            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(56, 189, 248, 0.45)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🔍</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#38BDF8" }}>"google.com"</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(16, 185, 129, 0.55)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🌐</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#10B981", fontFamily: nemiTheme.typography.fontFamily.mono }}>142.250.190.46</span>
            </div>
          </div>
      ...
      {isStage3 && (
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(6, 182, 212, 0.45)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🏠</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#F8FAFC" }}>ISP Gateway</span>
            </div>

            <span style={{ fontSize: 36, color: "#06B6D4", fontWeight: 900 }}>➔</span>

            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(6, 182, 212, 0.7)", display: "flex", alignItems: "center", gap: 16, boxShadow: "0 0 32px rgba(6, 182, 212, 0.4)" }}>
              <span style={{ fontSize: 50 }}>🌊</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#06B6D4" }}>Undersea Fiber Cable</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(16, 185, 129, 0.55)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>📍</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#10B981" }}>Google Edge POP</span>
            </div>
          </div>

          <div style={{ backgroundColor: "rgba(6, 182, 212, 0.18)", padding: "14px 32px", borderRadius: 26, border: "2px solid rgba(6, 182, 212, 0.45)", color: "#06B6D4", fontSize: 22, fontWeight: 900, fontFamily: nemiTheme.typography.fontFamily.mono }}>
        ...
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(16, 185, 129, 0.55)", display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <span style={{ fontSize: 26, fontWeight: 900, color: "#F8FAFC" }}>Borg Cluster</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(56, 189, 248, 0.55)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🔐</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#38BDF8" }}>TLS 1.3 Decrypt</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(15, 23, 42, 0.90)", padding: "18px 28px", borderRadius: 28, border: "2px solid rgba(255, 209, 102, 0.55)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>📦</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#FFD166" }}>42.8 KB Payload</span>
            </div>
          </div>
      ...
      {isStage5 && (
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", padding: "18px 28px", borderRadius: 28, boxShadow: "0 10px 30px rgba(0,0,0,0.09)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🌲</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#1E293B" }}>DOM Tree</span>
            </div>

            <span style={{ fontSize: 36, color: "#0284C7", fontWeight: 900 }}>➔</span>

            <div style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", padding: "18px 28px", borderRadius: 28, boxShadow: "0 10px 30px rgba(0,0,0,0.09)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🎨</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#0284C7" }}>CSSOM Style</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(255, 255, 255, 0.95)", padding: "18px 28px", borderRadius: 28, boxShadow: "0 10px 30px rgba(0,0,0,0.09)", display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 50 }}>🎮</span>
              <span style={{ fontSize: 26, fontWeight: 900, color: "#10B981" }}>GPU Paint</span>
            </div>
          </div>

          <div style={{ backgroundColor: "rgba(16, 185, 129, 0.16)", padding: "14px 32px", borderRadius: 26, border: "2px solid rgba(16, 185, 129, 0.4)", color: "#10B981", fontSize: 22, fontWeight: 900, fontFamily: nemiTheme.typography.fontFamily.mono }}>
        ...
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 26 }}>
            <div style={{ backgroundColor: "rgba(239, 68, 68, 0.18)", padding: "18px 32px", borderRadius: 28, border: "2px solid rgba(239, 68, 68, 0.5)", display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <span style={{ fontSize: 26, fontWeight: 900, color: "#EF4444" }}>Human Blink: 300ms</span>
            </div>
            ...
            <div style={{ backgroundColor: "rgba(16, 185, 129, 0.22)", padding: "18px 34px", borderRadius: 28, border: "3px solid #10B981", display: "flex", alignItems: "center", gap: 16, boxShadow: "0 0 40px rgba(16, 185, 129, 0.45)" }}>
              ...
              <span style={{ fontSize: 28, fontWeight: 900, color: "#10B981", fontFamily: nemiTheme.typography.fontFamily.mono }}>Round-Trip: 64ms</span>
            </div>
          </div>
