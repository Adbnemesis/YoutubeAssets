...
# Paths
VIDEO_PATH = "/Users/talus/Downloads/youtube_ai/OpenMontage/project_tech/out/NemiExplains_Trash_20260823.mp4"
...
IG_CAPTION = """Emptying the trash bin never erases your files — it only deletes the pointer.
.
.
.
.
.
#tech #algorithm #cybersecurity #storage #nemiexplains"""

YT_TITLE = "Why Emptying Trash Deletes Nothing 🗑️💾 #shorts"

YT_DESCRIPTION = """Emptying the trash bin never erases your files — it only deletes the pointer.
.
.
.
.
...
YT_TAGS = [
    "why deleting files does not erase data",
    "file recovery",
    "hard drive pointers",
...
print("="*60)
print("🚀 UPLOADING NEMI EXPLAINS REEL (TRASH / FILE DELETION) TO ALL PLATFORMS")
print("="*60)
